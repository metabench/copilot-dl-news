...
// Shared protocol + tiny observable implementation.
// Designed to run in both Node (CommonJS) and the browser (window global).
(function factory(root) {
    ...
    function emit(event, value) {
      ...
      for (const fn of [...arr]) {
        try {
          ...
          // Observables should not crash the app.
          try {
  ...
  if (typeof module !== 'undefined' && module.exports) {
    ...
    root.RemoteObservableShared = exported;
  }
