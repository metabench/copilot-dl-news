...
/**
 * ResizableSplitLayoutControl - An isomorphic resizable 2-column split layout
 * 
 ...
 *   context,
 *   leftPanel: navControl,
 *   rightPanel: contentControl,
 *   initialLeftWidth: 280
 * });
 * const html = layout.all_html_render();
 * 
 * // Client-side hydration
 * const el = document.querySelector("[data-jsgui-control='resizable_split_layout']");
 * const layout = new ResizableSplitLayoutControl({ context, el });
 * layout.activate();
 */
...
class ResizableSplitLayoutControl extends jsgui.Control {
  ...
  activate() {
    ...
    // Bind event handlers (store references for potential cleanup)
