...
class CrawlOrchestrationService {
  ...
  startCrawl(options = {}, dependencies = {}) {
    ...
    // Return result (not HTTP response - route handles that)
    return {
      jobId: job.id,
      process: child,
