 ...
 * It is kept for reference only and should not be used for new development.
 *
 * The new UI (v2) will be much simpler and focused on rendering data views from the database.
 * See src/ui/README.md for the new UI structure.
 */
