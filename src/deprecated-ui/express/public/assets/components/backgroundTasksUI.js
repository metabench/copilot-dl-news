      ...
      if (other instanceof Data_Model) {
        ...
        if (that2 === other) {
          ...
          if (that2 === void 0) {
            ...
            const { value } = that2;
            const t_value = tof2(value), t_other = tof2(other);
            if (t_value === t_other) {
              if (value === other) {
                return true;
              } else {
                    ...
                    if (t_value === "number" || t_value === "string" || t_value === "boolean") {
                      ...
                      if (t_value === "array") {
                        if (value.length === other.length) {
                          let res2 = true, c2 = 0, l = value.length;
                          do {
                            res2 = more_general_equals(value[c2], other[c2]);
                            c2++;
                          } while (res2 === true && c2 < l);
                          return res2;
                        } else {
                          return false;
                        }
...
var require_Data_Value = __commonJS({
  "node_modules/lang-tools/Data_Model/old/Data_Value.js"(exports, module2) {
...
var require_Data_Object = __commonJS({
  "node_modules/lang-tools/Data_Model/old/Data_Object.js"(exports, module2) {
    var jsgui = require_lib_lang_mini();
    ...
    var Data_Object = class extends Data_Model {
      ...
      */
      ...
      "set"() {
        ...
        var that2 = this, res2;
        var input_processors2 = jsgui.input_processors;
        if (a.l == 2 || a.l == 3) {
          ...
          if (!this._initializing && this._map_read_only && this._map_read_only[property_name]) {
            ...
            if (split_pn.length > 1 && property_name != ".") {
              ...
              if (!is_defined2(data_object_next)) {
                var tv = typeof value;
                var dv;
...
var require_Collection = __commonJS({
  "node_modules/lang-tools/Data_Model/old/Collection.js"(exports, module2) {
...
var require_Data_Object2 = __commonJS({
  "node_modules/lang-tools/Data_Model/Data_Object.js"(exports, module2) {
    module2.exports = require_Data_Object();
  }
});
...
var require_setup_data_value_data_type_set = __commonJS({
  "node_modules/lang-tools/Data_Model/new/setup_data_value_data_type_set.js"(exports, module2) {
    ...
    var { is_defined: is_defined2, input_processors, field, tof: tof2, each, is_array, Data_Type } = jsgui;
                      ...
                      if (t === "undefined") {
                        ...
                        if (t_value === "data_value") {
                          if (is_array(value2.value)) {
                            if (value2.value.length === local_js_value2.length) {
                          ...
                          if (t_value === "array") {
                            if (local_js_value2.length === value2.length) {
                              const l = value2.length;
                  ...
                  const general_value_processing = () => {
                    if (local_js_value2 instanceof Base_Data_Value) {
                      ...
                      if (value2 instanceof Data_Model) {
                        if (value2.equals(local_js_value2)) {
                        } else {
                          console.log("value", value2);
                          ...
                          if (property_data_types) {
                            ...
                            for (let i_property = 0; i_property < num_properties2; i_property++) {
                              ...
                              if (local_js_value2[i_property] instanceof Data_Value) {
                                local_js_value2[i_property].value = value2[i_property];
                              } else {
                                console.trace();
                                throw "NYI";
                              }
      ...
      constructor(spec = {}) {
        ...
        const attempt_set_value = this.attempt_set_value = (value) => {
          const get_local_js_value_copy = () => {
            const tljsv = tof2(local_js_value);
          ...
          if (old_equals_new === true) {
            ...
            if (this.data_type === void 0) {
              ...
              if (typeof value === "number") {
                const res2 = attempt_set_value(value + "");
...
var require_Data_Value3 = __commonJS({
  "node_modules/lang-tools/Data_Model/Data_Value.js"(exports, module2) {
    module2.exports = require_Data_Value2();
  }
});
...
// src/ui/express/public/components/AnalysisProgressBar.js
...
// src/ui/express/public/components/backgroundTasksUI.js
var require_backgroundTasksUI = __commonJS({
  "src/ui/express/public/components/backgroundTasksUI.js"(exports, module2) {
...
export default require_backgroundTasksUI();
