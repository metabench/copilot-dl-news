...
document.addEventListener("DOMContentLoaded", async () => {
  try {
    ...
    const { createSseHandlers } = await import("../chunks/sseHandlers-7JQGOZX2.js");
    console.log("[index] Importing crawlControls...");
    const { createCrawlControls } = await import("../chunks/crawlControls-GKJ6XWOV.js");
    console.log("[index] Importing jobsAndResumeManager...");
    const { createJobsAndResumeManager } = await import("../chunks/jobsAndResumeManager-VKCBP4NH.js");
    ...
    const { createCrawlProgressIntegration } = await import("../chunks/crawlProgressIntegration-HULSAHD3.js");
    ...
    const crawlProgress = createCrawlProgressIntegration({
      ...
      onProgressUpdate: async (event) => {
        if (event.type === "progress" || event.type === "telemetry") {
