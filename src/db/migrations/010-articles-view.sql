-- Articles View Migration
-- Version: 010
-- Description: Backward-compatible view exposing legacy article columns from normalized tables
...
VALUES (10, '010-articles-view', datetime('now'), 'Add backward-compatible denormalized articles view');
