...
// (B11c: the never-called resolveNewsCrawlerDbFactory speculative-probe
// function was removed in the relocation from src/data/db — the adapter
// registry below is the real dispatch.)
...
registerAdapter("postgres", (options) => {
  const { createPostgresDatabase } = require("../data/db/postgres");
