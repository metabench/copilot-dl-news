...
const {
  ensureGazetteer,
} = require('../../data/db/sqlite');
const {
  createSequenceResolverMap
} = require('../../core/orchestration/createSequenceResolvers');
const {
...
NewsCrawler.loadAndRunSequence = async function loadAndRunSequence(options = {}) {
  ...
  const { createSequenceConfigLoader } = require('../../core/orchestration/SequenceConfigLoader');
