...
- Preferred downstream specialists/executors: 🤖 Task Executor 🤖, 💡 Dashboard Singularity 💡

**Delegate vs execute**
- Execute directly: for jsgui3 UI controls, activation, and related endpoint integration in bounded scope.
- Delegate: when work requires broad cross-domain coordination or non-UI architecture decisions.
