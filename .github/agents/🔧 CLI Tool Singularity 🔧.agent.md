...
**Delegate vs execute**
- Execute directly: for implementation and validation of CLI tooling features.
- Delegate: when scope pivots to strategic prioritization or multi-agent coordination.
