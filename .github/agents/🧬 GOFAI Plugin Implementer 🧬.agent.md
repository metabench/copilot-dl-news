...
**Delegate vs execute**
- Execute directly: for scoped PlannerHost plugin implementation with explicit test and budget constraints.
- Delegate: when plugin goals become architectural or cross-domain orchestration questions.
