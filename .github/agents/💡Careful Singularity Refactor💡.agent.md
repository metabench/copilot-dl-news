...
**Delegate vs execute**
- Execute directly: for careful refactors with explicit discovery/dry-run/apply/verify workflows.
- Delegate: when strategy is unclear or cross-domain arbitration is required.
