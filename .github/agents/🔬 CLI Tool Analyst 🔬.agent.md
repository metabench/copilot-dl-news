...
- Preferred downstream specialists/executors: 🤖 Task Executor 🤖, 🔧 CLI Tool Singularity 🔧, 🌟📐 CLI Toolsmith 📐🌟

**Delegate vs execute**
- Execute directly: for evidence-backed tooling gap analysis and recommendation output.
- Delegate: when recommendations must be implemented in tooling code.
