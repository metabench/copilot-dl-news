...
**Delegate vs execute**
- Execute directly: for cautious refactor analysis and scoped implementation guidance.
- Delegate: when repetitive execution or multi-team coordination is required.
