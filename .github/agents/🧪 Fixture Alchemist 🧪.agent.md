...
**Delegate vs execute**
- Execute directly: for minimal deterministic fixture crafting and redaction/replay hygiene.
- Delegate: when scope expands to full test architecture or unrelated subsystem changes.
