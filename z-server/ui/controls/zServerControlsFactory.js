...
const { createServerItemControl } = require("./serverItemControl");
const { createServerListControl } = require("./serverListControl");
const { createServerUrlControl } = require("./serverUrlControl");
const { createLogControls } = require("./logControls");
const { createServerLogWindowControl } = require("./serverLogWindowControl");
const { createControlButtonControl } = require("./controlButtonControl");
const { createControlPanelControl } = require("./controlPanelControl");
const { createScanningIndicatorControl } = require("./scanningIndicatorControl");
const { createSidebarControl } = require("./sidebarControl");
const { createContentAreaControl } = require("./contentAreaControl");
const { createTitleBarControl } = require("./titleBarControl");
const { createZServerAppControl } = require("./zServerAppControl");
...
function createZServerControls(jsgui) {
  ...
  const ServerItemControl = createServerItemControl(jsgui, { StringControl });
  const ServerListControl = createServerListControl(jsgui, { ServerItemControl });
  const ServerUrlControl = createServerUrlControl(jsgui, { StringControl });
  ...
  const TitleBarControl = createTitleBarControl(jsgui, { StringControl });
