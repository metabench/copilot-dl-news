...
const { getAnalysisVersionStats, getPendingCount } = require('./analysis-version');
...
function createAnalysisServer(options = {}) {
  ...
  const resolvedAnalysisVersion = (analysisVersion ?? getAnalysisVersionStats().nextVersion);
