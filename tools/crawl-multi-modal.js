...
const { CliArgumentParser } = require(path.join(__dirname, '../src/utils/CliArgumentParser'));
const { CliFormatter } = require(path.join(__dirname, '../src/utils/CliFormatter'));
...
async function main() {
  ...
  const { createMultiModalCrawl, MultiModalCrawlManager } = require('../src/crawler/multimodal');
