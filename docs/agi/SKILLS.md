...
> Registry hygiene (2026-07-19 reconciliation): rows marked **⚠ missing** point at SKILL.md files that were registered but never created. They are kept for their trigger-phrase intent only. Create the file before advertising it, or delete the row.
...
| deep-research | deep research, deep think, multi-step reasoning, comprehensive analysis, iterative search, synthesis, Tree of Thought, chain of thought, report writing | `docs/agi/skills/deep-research/SKILL.md` **⚠ missing — registered but never written (verified 2026-07-19); treat the trigger list as a wishlist, do not follow the link** |
...
| sessions | sessions, create session, search sessions, resume session, archive, long-term sessions, session lifecycle, handoff, cross-repo sessions | `docs/agi/skills/sessions/SKILL.md` **⚠ missing — registered but never written (verified 2026-07-19); treat the trigger list as a wishlist, do not follow the link** |
...
| crawl-system-diagnostics | crawl health, pipeline check, error rates, save rates, stuck runs, content storage, data anomalies, diagnostic tools | `docs/agi/skills/crawl-system-diagnostics/SKILL.md` **⚠ missing — registered but never written (verified 2026-07-19); treat the trigger list as a wishlist, do not follow the link** |
| crawling-strategy | crawl strategy, hub discovery, country hubs, intelligent crawl, crawl planning, site structure, URL patterns, discover hubs, crawl new site, news crawl, endurance crawl | `docs/agi/skills/crawling-strategy/SKILL.md` **⚠ missing — registered but never written (verified 2026-07-19); treat the trigger list as a wishlist, do not follow the link** |
| subsystem-versioning | versioning, v1, v2, major rewrite, subsystem isolation, directory versioning, rebuild, new version | `docs/agi/skills/subsystem-versioning/SKILL.md` **⚠ missing — registered but never written (verified 2026-07-19); treat the trigger list as a wishlist, do not follow the link** |
| runaway-process-guard | runaway processes, infinite loops, timeout, circuit breaker, stuck command, hanging script, repetitive output, termination | `docs/agi/skills/runaway-process-guard/SKILL.md` **⚠ missing — registered but never written (verified 2026-07-19); treat the trigger list as a wishlist, do not follow the link** |
| skill-writing | write a skill, new skill, create skill, skill review, improve skill, skill quality, skill audit, meta-skill | `docs/agi/skills/skill-writing/SKILL.md` **⚠ missing — registered but never written (verified 2026-07-19); treat the trigger list as a wishlist, do not follow the link** |
| websocket-upgrade | websocket, live updates, real-time, replace SSE, replace polling, ws upgrade, location.reload | `docs/agi/skills/websocket-upgrade/SKILL.md` **⚠ missing — registered but never written (verified 2026-07-19); treat the trigger list as a wishlist, do not follow the link** |
