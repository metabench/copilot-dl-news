...
- [../../tools/agi/](../../tools/agi/) – The loop's own tooling: `cycle-metrics.js` (compounding verdict), `progress-svg.js` +
  `repo-activity.js` (the progress picture), `next-prompt.js` (next-cycle prompt generation).
