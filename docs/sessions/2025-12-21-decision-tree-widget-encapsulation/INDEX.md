...
**Objective**: Inventory remaining SQL leakage and propose next safe encapsulation/enforcement steps after integrating Decision Tree access into crawl-widget.
