...
## Risks & Mitigations
- Theme drift: pull gradient + stroke tokens directly from flagship Industrial Luxury Obsidian diagrams before drawing. ✅ Mitigated
- Visual imbalance at tiny sizes: design using 64×64 or 96×96 viewboxes and verify legibility down to 24px. ✅ Verified
- Missing documentation: capture palette + usage notes in WORKING_NOTES and summarize in SESSION_SUMMARY before closing. ✅ Documented
