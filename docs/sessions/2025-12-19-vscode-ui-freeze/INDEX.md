...
**Objective**: Reduce intermittent VS Code Insiders UI freezes by identifying hot processes and tightening workspace watcher/search excludes (especially large DB/artifacts).
