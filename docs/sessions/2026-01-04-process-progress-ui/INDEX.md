...
**Objective**: Build a pluggable UI + backend stream for monitoring long-running multi-stage tasks (backfills) with progress + logs, suitable for Electron viewing.
