...
**Objective**: Design and implement a continuous crawl mode that alternates between downloading batches, analyzing patterns, and re-analyzing content with new learnings
