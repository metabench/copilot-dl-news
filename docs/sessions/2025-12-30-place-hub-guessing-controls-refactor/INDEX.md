...
**Objective**: Refactor Place Hub Guessing UI server to use DB query module + isomorphic jsgui3 controls (no UI-layer SQL), while keeping existing checks passing.
