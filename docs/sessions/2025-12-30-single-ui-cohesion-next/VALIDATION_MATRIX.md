...
| Design Studio startup check | `node src/ui/server/designStudio/checks/designStudio.check.js` | Exit 0 | Console output |
| Regression tests | `npm run test:by-path tests/tools/__tests__/schema-sync.line-endings.test.js tests/ui/unifiedApp.registry.test.js tests/ui/docsViewer.mountPath.test.js tests/ui/designStudio.mountPath.test.js` | Exit 0 | Jest output |
