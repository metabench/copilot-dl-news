...
describe('Test Studio UI visual rerun (Guardian 10)', () => {
  jest.setTimeout(120_000);

  test('shows UI, runs 10-page crawl via rerun button, and displays passing result', async () => {
    ...
    const artifactDir = path.join(outputRoot, `test-studio-guardian-10-${nowTag}`);
    ...
    try {
      ...
      await page.waitForSelector('#rerun-guardian-10', { timeout: 20000 });
      ...
      await page.click('#rerun-guardian-10');
      ...
      await page.waitForFunction(
        () => {
          ...
          return rows.some((r) => (r.textContent || '').includes('guardian-like fixture crawl reaches 10 pages'));
        },
        { timeout: 20000 }
      );
